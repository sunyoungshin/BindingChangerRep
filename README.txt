Introduction：
This repository contains all the data that can be shared, scripts to run simulations and analysis, and scripts to generate plots and tables
...
The Binding Changer test runs with the package "atIndel" available at: https://github.com/sunyoungshin/atIndel  
